...
def write_opening_header(final_file, **header_params):
    ...
    write_data(final_file, "# https://ador.chorompotro.com/\n# Energized Unified Protection (Ad, Malware and Porn)\n# Version: " + time.strftime("%j.%m.%y", time.gmtime()) + "\n")
    ...
    write_data(final_file, "# Host Source: https://ador.chorompotro.com/energized/EnergizedUltimate\n# Raw Host: "
                           "https://raw.githubusercontent.com/AdroitAdorKhan/Energized/master/EnergizedUltimate\n")
    write_data(final_file, "# Project Web: https://ador.chorompotro.com/\n")
    write_data(final_file, "# Project Git: https://github.com/AdroitAdorKhan/Energized\n#\n")
    write_data(final_file, "# -================-Maintainer-================-\n# Nayem Ador - https://adroitadorkhan.github.io\n# -============================================-\n")
