...
def write_opening_header(final_file, **header_params):
    ...
    write_data(final_file, "# Host Source: https://ador.chorompotro.com/energized/EnergizedPorn\n# Raw Host: "
                           "https://raw.githubusercontent.com/AdroitAdorKhan/Energized/master/EnergizedPorn\n")
